...
public class IAPManagerGely :MonoBehaviour, IStoreListener
{
    internal bool debug;
    ...
    /// </summary>
    private static IAPManagerGely instance;
    public static IAPManagerGely Instance
    {
        get
        {
            if (instance == null)
