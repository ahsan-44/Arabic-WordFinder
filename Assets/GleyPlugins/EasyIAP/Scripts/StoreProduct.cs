...
public class StoreProduct
{
    ...
    public ProductTypeG productType;
    ...
    public StoreProduct(string productName, ProductTypeG productType, int value, string idGooglePlay, string idIOS, string idAmazon, string idMac, string idWindows)
    {
    ...
    public StoreProduct()
    {
        ...
        idMac = "";
        idWindows = "";
        productType = ProductTypeG.Consumable;
    }
